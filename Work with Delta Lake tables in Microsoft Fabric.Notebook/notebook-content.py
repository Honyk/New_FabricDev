...
df.write.format("delta").saveAsTable("external_products", path="abfss://Hon_dp_fabric@onelake.dfs.fabric.microsoft.com/first_lakehouse.Lakehouse/Files/external_products")
...
# MAGIC %%sql
# MAGIC 
# MAGIC SELECT count(*) FROM IotDeviceData;
